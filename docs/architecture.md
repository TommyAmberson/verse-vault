...
* **Rust core (`crates/core/`)** — pure algorithm: graph, FSRS, credit assignment, scheduling,
  sessions. No I/O, no async. Runs the same way on any target (native, WASM, mobile).
